  ...
  return (
    <div className='flex flex-col start w-[100%] min-h-[50vh] gap-10 ' >
        ...
        <div className='flex flex-col sm:flex-row justify-evenly flex-wrap gap-5  text-center items-center  '>
            <div className='flex flex-col w-[300px] items-center gap-2 h-[300px] justify-center p-8 border border-slate-400 hover:border-opacity-80 transition-all duration-300 border-opacity-30 rounded-md' >
            ...
            <div className='flex flex-col w-[300px] items-center gap-2 border justify-center h-[300px] border-slate-400 border-opacity-30 hover:border-opacity-80 transition-all duration-300 rounded-md p-8 ' >
            ...
            <div className='flex flex-col w-[300px] items-center gap-2 p-8 justify-center border h-[300px] border-slate-400 border-opacity-30 hover:border-opacity-80 transition-all duration-300 rounded-md' >
